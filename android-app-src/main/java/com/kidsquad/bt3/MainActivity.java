...
//***remember the connection will fail and app will crash if you haven't paired first
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        if(Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR2){
            ...
            //Log.d(TAG, "Trying to read " + mConnectionService.mGattCallback.toString());
            //mBTDevice.connectGatt(MainActivity.this,false, mGattCallback);
            //mBluetoothConnection = new BluetoothConnectionService(MainActivity.this);

            //google tutorial
            Intent gattServiceIntent = new Intent(this, BluetoothLeService.class);
            boolean bound = bindService(gattServiceIntent, mConnectionService, BIND_AUTO_CREATE);
            //Log.d(TAG, "it ran the connect part and got " + bound);
            //final boolean result = mBluetoothLeService.connect(mDeviceAddress);
            //Log.d(TAG, "Connect request result=" + result);

            //Log.d("myTag", mBluetoothLeService.toString());
...
//            setContentView(R.layout.controller);
    ...
    private void displayGattServices(List<BluetoothGattService> gattServices) {
        ...
        //Log.d("GattChars", mGattCharacteristics);
    }
